...
const sheetBestLink = "sheetbest_link";
const siteBase = "/";
...
const questionSwitch = () => {
  if (questionsPassed + 1 < quizStep.length) {
    ...
    progressBarLine.style.width =
      (100 / quizStep.length) * questionsPassed + "%";
    progressPercentage.innerText =
      Math.ceil((100 / quizStep.length) * questionsPassed) + "%";
